                ...
                <div className="p-6">
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                    <div>
                      ...
                      <p className="text-xl font-bold">{formatCurrency(asset.pricePerToken)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Total Supply</p>
                      <p className="text-xl font-bold">{formatNumber(asset.totalSupply)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Available</p>
                      <p className="text-xl font-bold">{formatNumber(asset.availableSupply)}</p>
                    </div>
                    <div>
                      <p className="text-sm text-gray-600">Market Cap</p>
                      <p className="text-xl font-bold">
                        {formatCurrency(asset.totalSupply * asset.pricePerToken)}
                      </p>
                    </div>
                  </div>
                </div>
